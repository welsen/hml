...
(function () {
	...
	u.d = function (a, c, d) {
		...
		e.W || (e.disabled = l, e.W = function (c) {
			if (!e.disabled) {
				...
				var d = e.z[c.type];
				if (d)
					for (var d = d.slice(0), k = 0, q = d.length; k < q && !c.mc(); k++) d[k].call(a, c)
			}
		});
	...
	u.k.fc = function (a, c) {
		var d, e, g;
		a = u.k.copy(a);
		for (d in c) w.call(c, d) && (e = a[d], g = c[d], a[d] = u.k.nc(e) && u.k.nc(g) ? u.k.fc(e, g) : c[d]);
		return a
	};
	u.k.copy = function (a) {
		return u.k.B({}, a)
	...
	function F(a, c) {
		...
		h = g = d.offsetWidth;
		d = a.handle;
		if (a.g.Ad) return h = e.top, e = c.changedTouches ? c.changedTouches[0].pageY : c.pageY, d && (d = d.v().offsetHeight, h += d / 2, g -= d), Math.max(0, Math.min(1, (h - e + g) / g));
		g = e.left;
	...
	function H(a) {
		a.oa = f;
		a.va.n("vjs-lock-showing");
		a.a.setAttribute("aria-pressed", f);
		a.I && 0 < a.I.length && a.I[0].v().focus()
	}
	...
	function J(a, c, d) {
		a.h ? (a.aa = l, a.h.D(), a.Db && (a.Db = l, clearInterval(a.Qa)), a.Eb && K(a), a.h = l) : "Html5" !== c && a.M && (u.l.gc(a.M), a.M = j);
		a.ia = c;
		a.aa = l;
		var e = u.k.B({
			source: d,
		...
		a.h.L(function () {
			...
			if (!this.m.progressEvents) {
				...
				a.Qa = setInterval(u.bind(a, function () {
					this.u.kb < this.buffered().end(0) ? this.j("progress") : 1 == this.Ia() && (clearInterval(this.Qa),
						this.j("progress"))
				}), 500);
			...
			this.m.timeupdateEvents || (a = this.b, a.Eb = f, a.d("play", a.Ac), a.d("pause", a.ya), a.h.U("timeupdate", function () {
	...
	t.currentTime = function (a) {
		return a !== b ? (this.u.oc = a, M(this, "setCurrentTime", a), this.Eb && this.j("timeupdate"), this) : this.u.currentTime = L(this, "currentTime") || 0
	};
	...
	t.volume = function (a) {
		if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.u.volume = a, M(this, "setVolume", a), u.rd(a), this;
	...
	t.xa = function () {
		...
		a ? (u.d(document, a.ub, u.bind(this, function (c) {
			this.H = document[a.H];
			this.H === l && u.o(document, a.ub, arguments.callee);
			this.j("fullscreenchange")
		})), this.a[a.uc]()) : this.h.Sa() ? M(this, "enterFullScreen") : (this.ad = f, this.Wc = document.documentElement.style.overflow, u.d(document, "keydown", u.bind(this, this.ic)), document.documentElement.style.overflow = "hidden", u.n(document.body, "vjs-full-window"), this.j("enterFullWindow"), this.j("fullscreenchange"));
		return this
	};
	t.nb = function () {
		var a = u.Nb.xa;
	...
	t.ic = function (a) {
		27 === a.keyCode && (this.H === f ? this.nb() : N(this))
	};

	function N(a) {
		a.ad = l;
		u.o(document, "keydown", a.ic);
		document.documentElement.style.overflow = a.Wc;
	...
	t.src = function (a) {
		if (a instanceof Array) {
			...
			(M(this, "src", a), "auto" == this.g.preload && this.load(), this.g.autoplay && this.play()) : this.L(function () {
				this.src(a)
			}));
		return this
	};
	...
	function I(a, c) {
		return c !== b ? (c = !!c, c !== a.Ob && ((a.Ob = c) ? (a.ja = f, a.t("vjs-user-inactive"), a.n("vjs-user-active"), a.j("useractive")) : (a.ja = l, a.h.U("mousemove", function (a) {
			a.stopPropagation();
			a.preventDefault()
		}), a.t("vjs-user-active"), a.n("vjs-user-inactive"), a.j("userinactive"))), a) : a.Ob
	}
	var O, P, Q;
	...
	t.xb = function () {
		var a;
		"Flash" === this.b.ia && this.b.seeking() ? (a = this.b.u, a = a.oc ? a.oc : this.b.currentTime()) : a = this.b.currentTime();
	...
	u.na = u.R.extend({
		i: function (a, c) {
			u.R.call(this, a, c);
			a.d("volumechange", u.bind(this, this.update));
			a.h && (a.h.m && a.h.m.Bc === l) && this.n("vjs-hidden");
			a.d("loadstart", u.bind(this, function () {
				a.h.m && a.h.m.Bc === l ? this.n("vjs-hidden") : this.t("vjs-hidden")
			}));
	...
	u.l = u.r.extend({
		i: function (a, c, d) {
			...
			if (u.Oc && a.options().nativeControlsForTouch !== l) {
				var e, g, h, k;
				e = this;
				g = this.K();
				c = g.controls();
			...
			for (a = u.l.Za.length - 1; 0 <= a; a--) u.d(this.a, u.l.Za[a], u.bind(this.b, this.Yc));
			this.Ta()
		}
	});
	t = u.l.prototype;
	...
	t.e = function () {
		var a = this.b,
			c = a.M,
			d;
		if (!c || this.m.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), u.l.gc(c), c = d, a.M = j) : c = u.e("video", {
			id: a.id() + "_html5_api",
			className: "vjs-tech"
	...
	u.Lc && (document.createElement("video").constructor.prototype.canPlayType = function (a) {
	...
	u.f = u.r.extend({
		i: function (a, c, d) {
			...
			e && (e.type && u.f.cd(e.type) ?
				(a = u.f.yc(e.src), k.rtmpConnection = encodeURIComponent(a.qb), k.rtmpStream = encodeURIComponent(a.Mb)) : k.src = encodeURIComponent(u.jc(e.src)));
			u.yb(g, d);
	...
	t.src = function (a) {
		u.f.bd(a) ? (a = u.f.yc(a), this.Od(a.qb), this.Pd(a.Mb)) : (a = u.jc(a), this.a.vjs_src(a));
		if (this.b.autoplay()) {
			var c = this;
			setTimeout(function () {
				c.play()
	...
	u.f.lb = function (a) {
		if (a.type in u.f.$c || a.type in u.f.zc) return "maybe"
	};
	u.f.$c = {
		"video/flv": "FLV",
		"video/x-flv": "FLV",
	...
	function X(a, c, d) {
		for (var e = a.za, g = 0, h = e.length, k, q; g < h; g++) k = e[g], k.id() === c ? (k.show(), q = k) : d && (k.J() == d && 0 < k.mode()) && k.disable();
		...
		if (0 < this.fa.length) {
			...
			if (this.Kb === b || a < this.Kb || this.La <= a) {
				var c = this.fa,
					...
					h = [],
					k, q, n, r;
				a >= this.La || this.La === b ? r = this.vb !== b ? this.vb : 0 : (g = f, r = this.Cb !== b ? this.Cb : c.length - 1);
				for (;;) {
					n = c[r];
					if (n.ua <= a) e = Math.max(e, n.ua), n.Ha && (n.Ha = l);
					else if (a < n.startTime) {
						if (d = Math.min(d, n.startTime), n.Ha && (n.Ha = l), !g) break
					} else g ? (h.splice(0, 0, n), q === b && (q = r), k = r) : (h.push(n), k === b && (k = r), q = r), d = Math.min(d, n.ua), e = Math.max(e, n.startTime),
						n.Ha = f; if (g)
						if (0 === r) break;
						else r--;
	...
	u.ab.prototype.update = function () {
		for (var a = W(this.b), c = 0, d = a.length, e, g = f; c < d; c++) e = a[c], e.J() == this.ca.J() && 2 == e.mode() && (g = l);
		this.selected(g)
	};
	u.S = u.R.extend({
		i: function (a, c) {
	...
	u.S.prototype.sa = function () {
		...
		for (var d = 0; d < W(this.b).length; d++) c = W(this.b)[d], c.J() === this.A && a.push(new u.Y(this.b, {
			track: c
		}));
		return a
	};
	...
	t.sa = function () {
		for (var a = [], c, d = 0; d < W(this.b).length; d++) c = W(this.b)[d], c.J() === this.A && a.push(new u.Y(this.b, {
			track: c
		}));
		return a
	};
	t.Ja = function () {
		for (var a = W(this.b), c = 0, d = a.length, e, g, h = this.I = []; c < d; c++)
			if (e = a[c], e.J() == this.A && e.tb()) {
				if (2 > e.readyState()) {
					this.Gd = e;
